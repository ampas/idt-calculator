...
class IDTProjectSettings(BaseSerializable):
    def __init__(self):
        ...
        self._aces_username = IDTProjectSettings.aces_username.metadata.default_value
    ...
    @idt_metadata_property(metadata=ProjectSettingsMetaDataConstants.ACES_USERNAME)
    def aces_username(self):
        return self._aces_username
